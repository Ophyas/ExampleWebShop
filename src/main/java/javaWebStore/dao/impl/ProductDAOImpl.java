...
public class ProductDAOImpl implements ProductDAO {
    ...
    @Override
    public PaginationResult<ProductInfo> queryProducts(int page, int maxResult, int maxNavigationPage, String category) {
        return queryProducts(page, maxResult, maxNavigationPage, null, "All");
    }
